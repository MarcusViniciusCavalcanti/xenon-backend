...
class UserServiceRegistryApplicationTest {
    ...
    void shouldThrowsEmailErrorExceptionWhenEmailExist() {
        var userServiceRegistryApplication = new UserServiceRegistryTest();
    ...
    class UserServiceRegistryTest implements UserServiceRegistryApplication {
