    ...
    static {
        TEMPLATE = """
            <!DOCTYPE html
                   ...
                   <head>
                   <!--[if gte mso 9]><xml>
                   <o:OfficeDocumentSettings><o:AllowPNG/><o:PixelsPerInch>96
                   ...
                   * {
                   ...
                   width="500" style="background-color:transparent;
                   ...
                   -ms-text-size-adjust: 100%;
                   -webkit-text-size-adjust: 100%;" valign="top"><span>
               ...
               src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/2966/pass-animate.gif"
                   ...
                   style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto;
                   ...
                   margin-bottom:0;"><strong>Solicitação de nova senha</strong>
                   </h1>
                   </td>
                   </tr>
                   </table>
                   ...
                   style="line-height: 1.5; font-size: 12px;
                   font-family: Tahoma, Verdana, Segoe, sans-serif; color: #393d47;
                   mso-line-height-alt: 18px;">
                   <p style="margin: 0; font-size: 14px;
                   line-height: 1.5; word-break: break-word;
                   text-align: center; mso-line-height-alt: 21px;
                   ...
                   line-height:120%;text-align:center;margin-top:0;
                   margin-bottom:0;"><strong>[---senha---]</strong></h1>
                   </td>
                   </tr>
                   </table>
                   <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0"
                   ...
                   font-size: 13px; mso-line-height-alt: 20px;
                   mso-ansi-font-size: 14px; margin-top: 0; margin-bottom: 0;">
                   <span style="font-size: 13px; mso-ansi-font-size: 14px;">
                   Se não foi você que solicitou, notifique
                   o administrador do Sistema Xenon
                   </span></p>
                   </div>
                   </div>
                   <!--[if mso]></td></tr></table><![endif]-->
                   ...
                   border-right:0px solid transparent; padding-top:0px; padding-bottom:0px;
                   padding-right: 0px; padding-left: 0px;">
                   <!--<![endif]-->
                   <div class="img-container center autowidth big"\040
